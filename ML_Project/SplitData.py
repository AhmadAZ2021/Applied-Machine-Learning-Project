...
def split_yolo_dataset(image_dir, output_dir, train_ratio=0.8, test_ratio=0.15, val_ratio=0.05):
    ...
    # Filter only those that have corresponding label (.txt) files
    labeled_images = []
    unlabeled_images = []
    ...
    # Move unlabeled images to 'unlabeled' folder
    ...
    # Shuffle and split labeled images
    ...
    # Helper to copy image and its label file
    ...
    # Copy labeled image-label pairs
...
# Example usage
split_yolo_dataset(r'C:\Users\20248106\Desktop\mapillary\images', r'C:\Users\20248106\Desktop\mapillary\SplittedData')
